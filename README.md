...
[Eg. project](https://github.com/laggingreflex/preact-minimal)
...
Run an http server with koa-ssr middleware configured

```sh
koa-ssr --port 8000
```

Put the options in a file named `'.koa-ssr.js'` in your project root.

Sample config:

```js
exports.port = 8000
exports.root = 'build' // root dir for koa-static and koa-ssr
exports.static = {} // opts for koa-static
exports.XXX = YYY // rest opts for koa-ssr
```

(note: above config is the default)
